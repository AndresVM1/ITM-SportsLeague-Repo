...

{
...

    {
...

        {
            ...
            new() { Name="Atlético Bucaramanga", City="Bucaramanga", Stadium="Alfonso López", FoundedDate=new DateTime(1949, 5, 21) },
            ...
            new() { Name="Boyacá Chicó FC", City="Tunja", Stadium="La Independencia", FoundedDate=new DateTime(2002, 1, 1) },

            new() { Name="Jaguares de Córdoba", City="Montería", Stadium="Jaraguay", FoundedDate=new DateTime(2012, 1, 1) },
